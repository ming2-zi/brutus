function convertBrutus() {
    let name = document.getElementById('name').value;
    const check = clickBtn1()
    if (check == 3) {
        name = convertToKatakana(name);
        document.getElementById('converted').innerHTML = name + 'お前もか！';
    }
    if (check == 1) {
        name = convertToRoman(name);
        document.getElementById('converted').innerHTML = 'Et tu ' + name + '!';
    }else if (check == 2) {
        name = convertToRoman(name);
        document.getElementById('converted').innerHTML = 'And you, ' + name + '!';
    }
}
